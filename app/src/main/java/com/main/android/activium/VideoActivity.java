...
import com.main.android.activium.util.CameraCapturerCompat;
import java.util.Collections;
import java.util.UUID;


import static com.main.android.activium.R.drawable.ic_phonelink_ring_white_24dp;
import static com.main.android.activium.R.drawable.ic_volume_up_white_24dp;
...
public class VideoActivity extends AppCompatActivity {
   ...
   /* private static final String TWILIO_ACCESS_TOKEN = BuildConfig.TWILIO_ACCESS_TOKEN;*/
    ...
    /*private static final String TWILIO_ACCESS_TOKEN = "FnJKII_1Z88WB";*/
    ...
    /*
    * Counter for token retrieval server calls
    */
    private int tokenRetrievalAttempts;
    ...
    final static String SERVER_TOKEN_URL = "server_url";
    ...
    protected void onResume() {
        ...
        enableAutomaticSubscription = getAutomaticSubscriptionPreference
                (VideoSettingsActivity.PREF_ENABLE_AUTOMATIC_SUBSCRIPTION,
        ...
        if (room != null) {
            reconnectingProgressBar.setVisibility((room.getState() != Room.State.RECONNECTING) ?
                    View.GONE :
                    View.VISIBLE);
            videoStatusTextView.setText(R.string.connected);
        }
    }
    ...
    private void createAudioAndVideoTracks() {
        ...
        localAudioTrack = LocalAudioTrack.create(VideoActivity.this, true,
                LOCAL_AUDIO_TRACK_NAME);

        // Share your camera
        cameraCapturerCompat = new CameraCapturerCompat(VideoActivity.this,
                getAvailableCameraSource());
        localVideoTrack = LocalVideoTrack.create(VideoActivity.this,
                true, cameraCapturerCompat.getVideoCapturer(), LOCAL_VIDEO_TRACK_NAME);
    ...
    private void setAccessToken(String twilioAccessToken) {
    ...
    private void intializeUI() {
        ...
        connectActionFab.setOnClickListener(this::connectActionClickListener);
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onReconnecting(@NonNull Room room, @NonNull TwilioException twilioException) {
                videoStatusTextView.setText(R.string.reconnecting);
    ...
    private void connectActionClickListener(View v) {
    ...
    private void retrieveAccessTokenfromServer() {
        ...
        //Log.d(TAG, "Identity at server call: " + mIdentity);

        JsonObject queryObject = new JsonObject();
        queryObject.addProperty("identity", mIdentity);
        queryObject.addProperty("video", true);
        queryObject.addProperty("roomName", ROOM_NAME);
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (e == null) {
                            ...
                            /*
                             * initialize UI and connect session
                             */
                            intializeUI();
                            connectActionClickListener(connectActionFab);
                        } else {
                            ...
                            Toast.makeText(VideoActivity.this,
                                    ...
                                    .show();
                            while (tokenRetrievalAttempts < 3) {
                                retrieveAccessTokenfromServer();
                                tokenRetrievalAttempts += 1;
                            }
                        }
                    }
                });
    ...
    private boolean chkAuth(){
        ...
        if (!stitchClient.getAuth().isLoggedIn()) {
            ...
            if(user != null){
                uId = user.getId();
                if (uId != null) {
                    // set Twilio access token identity value to userId
                    mIdentity = uId;
                    //Log.d(TAG, "mIdentity set: : " + mIdentity);
                    /*retrieveAccessTokenfromServer();*/
                }else{
                    Log.e(TAG, "User id not found!: " + uId);
                }
